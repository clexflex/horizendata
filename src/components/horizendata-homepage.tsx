...
// Move all section components OUTSIDE of the main component
  ...
  <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
    ...
    <div className="container px-4 z-10 relative">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Fixed Search Form */}
        <form onSubmit={onSearchSubmit} className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto mb-12">
...
const TrendingStatistics: React.FC<TrendingStatisticsProps> = ({ activeCategory, onCategoryChange }) => (
...
interface PricingPlansProps {
  isYearly: boolean;
  onYearlyToggle: (yearly: boolean) => void;
}

const PricingPlans: React.FC<PricingPlansProps> = ({ isYearly, onYearlyToggle }) => (
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-12">
        ...
        <div className="flex items-center justify-center mt-8">
          ...
          <Switch checked={isYearly} onCheckedChange={onYearlyToggle} />
...
// Main component with props and callbacks
export default function HorizendataHomepage() {
  ...
  const handleYearlyToggle = useCallback((yearly: boolean) => {
    setIsYearly(yearly);
  }, []);
  ...
  return (
    <div className="min-h-screen">
      ...
      <PricingPlans 
        isYearly={isYearly}
        onYearlyToggle={handleYearlyToggle}
      />
